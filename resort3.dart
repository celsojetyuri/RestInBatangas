...
class Resort3 extends StatefulWidget {
  const Resort3({super.key});

  @override
  _Resort3State createState() => _Resort3State();
}

class _Resort3State extends State<Resort3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Buceo Anilao Resort'),
      ),
            ...
            Material(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Located in Batangas City, this hotel provides basic amenities like free Wi-Fi, '
                      'air conditioning, and 24-hour reception. It is a budget-friendly option with rates '
                      'starting from P778 per night. ',
