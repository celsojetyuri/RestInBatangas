...
class _Hotel2State extends State<Hotel2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('RedDoorz Hotel'),
      ),
          ...
          children: [
            ...
            Container(
              ...
              child: GridView.count(
                ...
                mainAxisSpacing: 8.0,
                children: [
                  Image.asset('assets/hotel2_1.jpg', fit: BoxFit.cover),
                  Image.asset('assets/hotel2_2.jpg', fit: BoxFit.cover),
                  Image.asset('assets/hotel2_3.jpg', fit: BoxFit.cover),
                  Image.asset('assets/hotel2_4.jpg', fit: BoxFit.cover),
                ],
              ),
            ),
